...
function loadScript(name, url) {
    return new Promise((resolve)=>{
        var script = document.getElementById("tronsmartcontractspace-" + name);
        if (script != null) {
        ...
        script.setAttribute("id", "tronsmartcontractspace-" + name);
...
export function getVersions() {
    return new Promise(async (resolve, reject) => {
        try {
            ...
            var urlTron = "https://tronsmartcontract.space/tron-solc-bin/list.js";
